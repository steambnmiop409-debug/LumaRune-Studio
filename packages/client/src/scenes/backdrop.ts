...
export class Backdrop {
  ...
  constructor(map: WorldMap) {
    ...
    weather.wind = 0.3;
    this.input = { minute: 1112, day: 14, weather, raining: false, soil: {}, placed: [], shipPresent: true, cargo: 6, players: [], forage: {}, boardFresh: false, debris: {}, nodes: {}, now: 0, greenhouse: true };
