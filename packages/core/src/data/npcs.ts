...
export const NPCS: NpcDef[] = [
  {
    ...
    lines: {
      greet: ['어서 와요! 오늘도 흙냄새가 좋네요.', '씨앗 봉투 뒤에 적힌 기온을 꼭 봐 주세요.', '아침엔 언덕에 들꽃을 보러 가요.'],
  ...
  },
  {
    ...
    lines: {
      greet: ['뭐든 고쳐 줄게. 망치 소리가 좀 시끄럽겠지만.', '스프링클러 하나면 아침이 한결 여유로워져.', '상자는 넉넉히 사 두는 게 좋아.'],
  ...
  },
  {
    ...
    dislikes: ['crop.onion'],
    lines: {
      greet: ['상자는 17시 전까지 실어 줘. 바다는 기다려 주지 않거든.', '좋은 작물일수록 뭍에서 값을 잘 쳐줘.', '같은 걸 한꺼번에 너무 많이 보내면 값이 떨어져.'],
  ...
  },
  {
    ...
    lines: {
      greet: ['오늘 하늘 색은 연보라와 살구색 사이야.', '밤에 등대 빛줄기를 보러 와. 파도가 은색으로 빛나.', '그림 그릴 풍경이 많은 섬이야.'],
  ...
  },
  {
    ...
    lines: {
      greet: ['안녕! 농부 언니, 오빠! 오늘은 뭐 심어?', '해변에서 반짝이는 유리를 찾았어!', '분수에 동전 던지면 소원 이뤄진대!'],
